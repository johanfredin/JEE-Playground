...
public class Address implements IdHolder {
	 ...
	 * @param id the identifier of this {@link Address}
	 ...
	 */
	public Address(long id, String street, String city, String zipCode, String stateOrRegion) {
		this(id, street, city, zipCode, stateOrRegion, "");
	}
	 ...
	 */
	public Address(long id, String street, String city, String zipCode, String stateOrRegion, String country) {
		setId(id);
		setStreet(street);
		setCity(city);
		setZipCode(zipCode);
	...
	/**
	 * @return the {@link Venue} address belongs to
	 */
	...
	public void copyDataFromEntity(IdHolder populatedEntity) {
		...
		setVenue(populatedAddres.getVenue());
